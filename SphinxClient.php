...
class SphinxClient
{
	...
	function __destruct()
	{
		if ( $this->_socket !== false &&  $this->_socket !== NULL)
			fclose ( $this->_socket );
	}
	...
	function AddQuery ( $query, $index="*", $comment="" )
	{
		...
		foreach ( (array)$this->_indexweights as $idx=>$weight )
		...
		foreach ((array) $this->_fieldweights as $field=>$weight )
		...
		foreach ( (array)$this->_overrides as $key => $entry )
		{
