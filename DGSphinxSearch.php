...
class DGSphinxSearch extends \yii\base\Component
{
    ...
    /**
     * @brief init models\DGSphinxSearchResult interator for search results
     * @param array $data
     * @param stdObject $criteria
     * @return models\DGSphinxSearchResult
     */
    protected function initIterator(array $data, $criteria = NULL)
    {
        $iterator = new models\DGSphinxSearchResult($data, $criteria);
